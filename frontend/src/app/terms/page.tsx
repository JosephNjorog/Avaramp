    ...
    >
      ...
      <Section id="definitions" title="2. Definitions">
        ...
        <div className="space-y-2 mt-2">
          {[
            ...
            { term: "\"Protocol Fee\"",        def: "The fee charged by AvaRamp per successful Settlement, currently 3% of the Payment value unless otherwise agreed in writing." },
      ...
      <Section id="fees" title="7. Fees & Charges">
        <SubSection title="7.1 Protocol Fee">
          <p>AvaRamp charges a Protocol Fee of <strong>3% per successful Settlement</strong>. This fee is deducted from the fiat amount before payout. No fee is charged on failed, expired, or unconfirmed payments.</p>
